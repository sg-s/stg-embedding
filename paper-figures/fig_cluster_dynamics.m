...
show_these_states = categorical({'normal','irregular-bursting','LP-weak-skipped','irregular','PD-silent','aberrant-spikes','LP-silent-PD-bursting','LP-silent','interrupted-bursting'});
