...
all_dirs = filelib.folders(data_root);

data_dirs =  {all_dirs.name};
...
if exist('cache/all_ph_data.mat','file') ~= 2
    ...
    if ~exist('data','var')
        ...
        for i = length(data_dirs):-1:1
            ...
            data(i) = crabsort.consolidate('neurons',{'PD','LP'},'stack',false,'DataDir',[data_root filesep data_dirs{i}],'ChunkSize',20,'UseParallel',false, 'DataFun',{@getPH});
